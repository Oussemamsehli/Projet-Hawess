    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4">Tourism Store</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Pages</a></li>
                    <li class="breadcrumb-item active text-white">Store</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-fluid packages py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">Store</h5>
                    <h1 class="mb-0">Awesome Store</h1>
                </div>
        ...
        <select id="Category" class="w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-2 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700">
           <?php
            ...
            ?>            
                                                ...
                                                <option  class="dark:text-slate-700">Vetements</option>
                                                <option  class="dark:text-slate-700">kits randoné</option>
                                                <option  class="dark:text-slate-700">kits camping</option>
                                                <option  class="dark:text-slate-700">Cadeaux souvenirs</option>
                                                <option  class="dark:text-slate-700">Aliments</option>
...
<!-- Tri de produit par prix-->
  <body>
      <h1> Triés par Intervalle de Prix</h1>
...
// Récupérer la connexion à la base de données depuis config.php
$pdo = config::getConnexion();

// Query pour récupérer les données de la table 'boutique'
$query = "SELECT * FROM boutique";
$result = $pdo->query($query);

// Boucle à travers les données récupérées et les afficher
while ($row = $result->fetch(PDO::FETCH_ASSOC))  {
    echo '<div class="col-lg-4 col-md-6">';
    echo '<div class="Hebergement-card-item">';
    echo '<div class="Hebergement-card-img">';
    echo '<a href="#">';
    echo '<img src="http://localhost/Boutique_en_ligne/Ressources/images/' . basename($row['image_path']) . '" alt="Produit Images" />';
    echo '</a>';
 
    echo '</div>';
    echo '<div class="Hebergement-card-text">' . $row['prix'] . '</div>';
    echo '<ul>';
    
    echo '<li class="active">Available Now</li>';
   
 //   echo '<li>' . $row['jours'] . ' Days Long</li>'; // Ajout de la durée en jours
    echo '</ul>';
    echo '<div class="Hebergement-card-content">';
    echo '<a href="#">';
    echo '<h3>' . $row['nom'] . '</h3>';
    echo '</a>';
   echo '<p>' . $row['description'] . '</p>';
   /* echo '<p>Type: ' . $row['type'] . '</p>'; // Ajout du type d'hébergement
    echo '<p>Équipements: ' . $row['equipement'] . '</p>'; // Ajout des équipements
    echo '<p>Adresse: ' . $row['adresse'] . '</p>'; // Ajout de l'adresse*/
  /*  echo '<p>Évaluations: ' . $row['Evaluation'] . '</p>';*/ // Ajout des évaluations
    echo '<a href="?id=' . $row['id'] . '" class="Hebergement-book-btn">Reserver</a>';
...
<div class="flex justify-between mt-4">
                                                <div class="self-center">
                                                    <p class="dark:text-slate-400">Plus 1 - 20 of 1,524</p>
                                                </div>
                                                <div class="self-center">
