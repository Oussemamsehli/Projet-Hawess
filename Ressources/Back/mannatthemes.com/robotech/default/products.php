...
<!-- Mirrored from mannatthemes.com/robotech/default/products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Mar 2024 18:18:13 GMT -->
<head>
        <meta charset="utf-8" />
                                    ...
                                    <div class="flex flex-wrap gap-4 mb-3">
                                        <div class="mb-2 w-44">                                           
                                            <select id="Category" class="w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-2 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700">
                                                ...
                                                <option  class="dark:text-slate-700">Categorie 1</option>
                                                <option  class="dark:text-slate-700">Categorie 2</option>
                                                <option  class="dark:text-slate-700">Categorie 3</option>
                                                <option  class="dark:text-slate-700">Categorie 4</option>
                                                <option  class="dark:text-slate-700">Categorie 5</option>
                                            </select> 
                                        </div>
                                        <div class="mb-2 w-36">
...
<!-- Mirrored from mannatthemes.com/robotech/default/admin-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Mar 2024 18:18:15 GMT -->
</html>