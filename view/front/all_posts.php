                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="index.html" class="nav-item nav-link">Home</a> 
                         <a href="/Projet-Hawess/campings/index.php" class="nav-item nav-link">camping and desttination</a>
...
?>
   ...
   document.addEventListener('DOMContentLoaded', function () {
    ...
    <input type="hidden" id="userId1" name="userId1" value="">
        ...
        <script>
               document.addEventListener('DOMContentLoaded', function () {
            // Set userId from localStorage to the form input
            document.getElementById("userId1").value = localStorage.getItem("userId");
        });
