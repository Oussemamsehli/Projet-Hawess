              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Oussema Msehli</p>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="editCamping.php?id=<?php echo $camping['idCamping']; ?>">Modifier</a> <a href="deleteCamping.php?id=<?php echo $camping['idCamping']; ?>">Supprimer</a></td>
                          </tr>
                          <?php }} ?>
                        </tbody>
                      </table>
