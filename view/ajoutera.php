				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-12">
							<h1 class="text-black d-flex justify-content-center">
								Ajouter un <span>Message</span>	
							</h1>
                            <br>	
                            ...
                            <div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="form-group mrb-0">
										<button type="submit" class="btn btn-primary mt-3">Ajouter Message</button>
										<a href="afficher.php" class="btn btn-link mt-3">Afficher Forum</a>
									</div>
								</div>
							</div>
						</form>
