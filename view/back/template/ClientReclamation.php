<?php
require_once "C:/xampp/htdocs/Projet-Hawess-forum/controller/reclamationController.php";
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="/Projet-Hawess/user/profile.php">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
            <span class="menu-title" >Page Accueil</span>
            </a>
          </li>
        </ul>
      </nav>
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button"  href="../../front/all_posts.php">+ ajouter une nouvelle reclamation </a>
