<?php
require_once "C:/xampp/htdocs/Projet-Hawess-forum/controller/postController.php";
  ...
  <body>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <?php foreach ($posts as $post) { ?>
                          <tr>
                          <td>
                            <img class="img-fluid w-100 rounded-top" src="../../front/uploads/<?php echo $post['image']; ?>" alt="Image">
                             
                            </td>
                            <td><?php echo $post['UserID']; ?></td>
                          <td><?php echo $post['title']; ?></td>
                                                    <td><?php echo $post['Content']; ?></td>
                                                    <td><?php echo date("d M Y", strtotime($post['Timestamp'])); ?></td>
                                                    <td>
                                        
                                                    <button type="button" class="btn btn-info edit-post-btn" data-toggle="modal" data-target="#editPostModal" data-post-id="<?php echo $post['ID']; ?>" data-post='<?php echo json_encode($post); ?>'>Edit</button>
                                       
                                        <form action="../deletePostHandlerAdmin.php" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <form id="editPostForm" method="post" action="../updatePostHandlerAdmin.php" enctype="multipart/form-data">
    ...
    editPostButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            document.getElementById('currentPostImage').setAttribute('src', '../../front/uploads/' + postData['image']); // Update image src
        });
    });
});
</script>
