...
<body>
    ...
    <div class="container-fluid bg-primary px-5 d-none d-lg-block">
        <div class="row gx-0">
            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <a href="../user/profile.php"><small class="me-3 text-light"><i class="fa fa-user me-2"></i>Mon profile</small></a>
                    <a href="/Projet-Hawess/view/front/all_posts.php"><small class="me-3 text-light"><i class="fa fa-user me-2"></i>Blog</small></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <!-- <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="camping.php" class="nav-item nav-link active">Campings</a>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-3 mb-4">Campingss</h1>
                <!-- <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Pages</a></li>
                    <li class="breadcrumb-item active text-white">Campings</li>
                </ol> -->
        </div>
    </div>
    <!-- Header End -->
                    ...
                    foreach ($campings as $camping) { ?>
                        <div class="packages-item">
                            <div class="packages-img">
                                <img src="../images/<?php echo $camping['image']; ?>" class="img-fluid w-100 rounded-top"
                                    alt="Image">
                                <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                                    style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                                    <small class="flex-fill text-center border-end py-2"><i
                                            class="fa fa-calendar-alt me-2"></i><?php echo $camping['date_debut']; ?></small>
                                    <small class="flex-fill text-center py-2"><i
                                            class="fa fa-user me-2"></i><?php echo $camping['place']; ?> Person</small>
                                </div>
                            ...
                            <div class="packages-content bg-light">
                                <div class="p-4 pb-0">
                                    <h5 class="mb-0"><a
                                            href="activite.php?id=<?php echo $camping['idCamping']; ?>"><?php echo $camping['titre']; ?></a>
                                    </h5>
